# Privacy Policy for Genie 3

## Introduction

Welcome to Genie 3, the **AI-powered image-to-video generator** designed to transform your static images into dynamic, professional-quality videos. At Genie 3, your privacy is of utmost importance to us, and this privacy policy outlines how we collect, use, and protect your personal information when you use our services.

## Information Collection and Use

We collect the following types of data to provide you with a better experience while using Genie 3:
...
2. **Usage Details**
   ...
   - **What We Collect**: Information about how you use Genie 3, including your interactions, features accessed, video generation frequency, and image upload patterns.
   - **Purpose**: To analyze user engagement and improve our services.

3. **Device Information**

   - **What We Collect**: Data regarding the devices you use to access Genie 3, such as device type, operating system, and browser type.
   - **Purpose**: To optimize our video generation services for different devices and ensure compatibility.
...
**Copyright Owner**: [freegenie3.com](http://freegenie3.com)
**Email**: [rockyandtom@gmail.com](mailto:rockyandtom@gmail.com)

By using Genie 3, you consent to our privacy policy and agree to its terms. Thank you for trusting us with your information!
